...
pid14.pred <- ggplot(data=p.ab %>% filter(dpi == 14), aes(x=primary_treatment, y=elisa_od, color=fct_rev(primary_treatment)))+
  ...
  geom_point(data=dat.new, aes(x=primary_treatment, y=yhat), size=10, shape="-", color="brown")+#model predictions
...
ggplot(m.cv, aes(x=dpi, y=bird_pv))+
  ...
  geom_line(aes(x=dpi, y=bird_pv, color=fct_rev(primary_treatment)))+
  scale_alpha_manual(values = c(0.5,1))+
  scale_color_manual(values = c(pri_colors))+
  labs(x="Days Post Primary Inoculation", y="Variability Metric", color="Primary Treatment", alpha = "Variability Metric")+
  theme_minimal()
