...
ggplot(m.abs, aes(x=dpi, y=prop_seropos, color=primary_treatment))+
  geom_point(size = 3)+
  scale_color_manual(values = pri_colors)+
  labs(x = "Day Post Infection", y = "Proportion Seropositive", color= "Primary Treatment") 
...
m.ab1<-m.ab %>%
  dplyr::select(dpi, quantity, elisa_od, band_number, infected_prim, infected_sec, seropos, ever_seropos, diseased, ever_diseased,
