...
a<- ggplot(wibird1, aes(x=elisa_od_41, y=elisa_od_56, shape=primary_treatment, color=as.factor(secondary_dose)))+
  geom_point()+
  facet_grid(~inf_sec~primary_treatment)

b <-ggplot(wibird1, aes(x=elisa_od_14, y=elisa_od_56, shape=primary_treatment, color=as.factor(secondary_dose)))+
  geom_point()+
  facet_grid(~inf_sec~primary_treatment)
